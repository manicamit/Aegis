          ...
          <div className="bench-grid">
            <div className="bench-card">
              <h3>
                ...
                <span className="helper">last 7 days · 5M tx evaluated</span>
              </h3>
              <table className="cmp-table">
                ...
                <tbody>
                  <tr><td>ROC-AUC</td>             <td>0.924</td>              <td className="is-good">0.942</td><td><span className="delta">+1.9%</span></td></tr>
                  <tr><td>Precision</td>           <td>0.731</td>              <td className="is-good">0.873</td><td><span className="delta">+19%</span></td></tr>
                  <tr><td>Recall</td>              <td>0.718</td>              <td className="is-good">0.812</td><td><span className="delta">+13%</span></td></tr>
                  <tr><td>F1 Score</td>            <td>0.722</td>              <td className="is-good">0.841</td><td><span className="delta">+16%</span></td></tr>
                  <tr><td>False Positive Rate</td> <td className="is-bad">0.371</td><td className="is-good">0.041</td><td><span className="delta">−89%</span></td></tr>
                  <tr><td>Alerts / day</td>        <td className="is-bad">1 240</td><td className="is-good">132</td>  <td><span className="delta">−9.4×</span></td></tr>
                  <tr><td>Mean review time</td>    <td>18 m</td>               <td className="is-good">7 m</td>    <td><span className="delta">−61%</span></td></tr>
                </tbody>
              </table>
            </div>
